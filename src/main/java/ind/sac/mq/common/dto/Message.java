...
public class Message extends CommonRequest {
    ...
    public String toString() {
        return "Message(topic=" + this.getTopic() + ", tags=" + this.getTags() + ", payload=" + java.util.Arrays.toString(this.getPayload()) + ", bizKey=" + this.getBizKey() + ", shardingKey=" + this.getShardingKey() + ")";
    }
}
