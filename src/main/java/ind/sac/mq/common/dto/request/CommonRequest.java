...
public class CommonRequest implements Serializable {
    ...
    public CommonRequest(long traceId, MethodType methodType) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CommonRequest other)) return false;
    ...
    public String toString() {
        return "CommonRequest(traceId=" + this.getTraceId() + ", methodType=" + this.getMethodType() + ")";
    }
}
